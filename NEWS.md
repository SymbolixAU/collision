...
* Adjusted "simple-simulation-example" vignette
  - Fixed issue with the example data.  Set it up to be a better distribution so it's easier to use for demonstration purposes
  - Added a second turbine model to the set of turbines to show an example of a more complex setup
