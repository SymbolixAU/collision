...
turbine_model1 <- define_turbine(
  ...
  max_nac_l = 20,
  max_width_nacelle = 3,
  rpm = set_random("rlnorm", meanlog = log(6.5), sdlog = log(2)),
  rotor_diam = 180,
  tilt_deg = 6,
...
turbine_model2 <- define_turbine(
  ...
  max_nac_l = 13,
  max_width_nacelle = 3,
  rpm = set_random("rlnorm", meanlog = log(9.1), sdlog = log(2)),
  rotor_diam = 150,
  tilt_deg = 6,
  prop_operational = 0.98
)
...
wte <- define_bird(
  ...
  bird_length = set_random("rpert", min = 0.85, max = 1.05,
                           mean = 0.945, shape = 2) ,
  bird_speed = set_random("rlnorm", meanlog = log(17), sdlog = log(3)),
