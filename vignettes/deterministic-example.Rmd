...
# TEO: Should this be flights / m^2 / min? 
...
# TEO: Is variability the right word here? The correction is more about use than variation.
# Maybe daily and monthly use?
# Also, prop_year doesn't have a monthly association based
# on the definition as "proportion of the year (relative to the time 
# period of the survey) the bird is active onsite", so should we say
# "yearly" use? 
