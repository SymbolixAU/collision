...
is a combined dataset of 100 point count surveys, including the count (`size`) of raptors (and associated distance at first observation (`distance`)). If none were seen we have an `NA` record for the observation.
