...
#' 
#' area_separate <- nrow(df_turbines)* pi*(eff_detection_width)^2
#' 
#' 
...
#'   )
#' 
#' sf_turbines <- sf::st_as_sf(df_turbines, coords = c("lon", "lat"), crs = 4326)
#' 
#' all(sf::st_is_valid(sf_turbines))
#' 
#' stopifnot("dataset contains invalid coordinates. Check values and crs",
#'           all(sf::st_is_valid(sf_turbines))  
#' )
#' 
#' 
